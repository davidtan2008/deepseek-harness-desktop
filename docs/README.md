...
| 理解 Agent turn 和变更归因 contract | [Agent Transport](adr/0005-agent-transport-contract.md) · [Context Sources](context-sources.md) · [Change Projection](change-projection.md) |
