...
| Agent diff attribution | 部分验证 | `workspace/changes` changed paths 已投影，ChangesPanel 可按 turn 加载当前 Git diff；before/after diff、watcher 冲突和 per-hunk Review UI 仍待接入 |
